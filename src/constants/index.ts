export const tryrollBaseUrl = "https://tryroll.com";
export const stakingTermsUrl = `${tryrollBaseUrl}/protocol-terms-of-service/`;
export const faqUrl = "https://support.tryroll.com/hc/en-us";
export const blogUrl = `${tryrollBaseUrl}/blog`;
